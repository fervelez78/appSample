 ...
 *         &lt;element name="SendReferralID" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "CommonDataCross.RegisterReferralResponse")
public class CommonDataCrossRegisterReferralResponse {

    @XmlElement(name = "Btinreq", required = true)
    protected SBTInReq btinreq;
    @XmlElement(name = "SendReferralID")
    protected int sendReferralID;
     ...
     * 
     */
    public void setSendReferralID(int value) {
