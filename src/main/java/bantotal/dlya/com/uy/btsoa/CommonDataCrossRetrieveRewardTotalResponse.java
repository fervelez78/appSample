 ...
 *         &lt;element name="TotalAcc" type="{http://www.w3.org/2001/XMLSchema}double"/>
...
@XmlRootElement(name = "CommonDataCross.RetrieveRewardTotalResponse")
public class CommonDataCrossRetrieveRewardTotalResponse {

    @XmlElement(name = "Btinreq", required = true)
    protected SBTInReq btinreq;
    @XmlElement(name = "TotalAcc")
