 ...
 *         &lt;element name="Banks" type="{http://uy.com.dlya.bantotal/BTSOA/}Banks"/>
...
@XmlRootElement(name = "CommonDataCross.RetrieveBankResponse")
public class CommonDataCrossRetrieveBankResponse {
     ...
     *     
     */
    public void setBanks(Banks value) {
        this.banks = value;
    }
