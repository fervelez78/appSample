 ...
 *         &lt;element name="ReferralSenderAmt" type="{http://www.w3.org/2001/XMLSchema}double"/>
 *         &lt;element name="ReferralRecieverAmt" type="{http://www.w3.org/2001/XMLSchema}double"/>
...
@XmlRootElement(name = "CommonDataCross.RetrieveRewardsResponse")
public class CommonDataCrossRetrieveRewardsResponse {

    @XmlElement(name = "Btinreq", required = true)
    protected SBTInReq btinreq;
    @XmlElement(name = "ReferralSenderAmt")
    protected double referralSenderAmt;
    @XmlElement(name = "ReferralRecieverAmt")
    protected double referralRecieverAmt;
    ...
    /**
     * Gets the value of the referralSenderAmt property.
     * 
     */
    public double getReferralSenderAmt() {
        return referralSenderAmt;
    }

    /**
     * Sets the value of the referralSenderAmt property.
     * 
     */
    public void setReferralSenderAmt(double value) {
        this.referralSenderAmt = value;
    }

    /**
     * Gets the value of the referralRecieverAmt property.
     * 
     */
    public double getReferralRecieverAmt() {
        return referralRecieverAmt;
    }

    /**
     * Sets the value of the referralRecieverAmt property.
     * 
     */
    public void setReferralRecieverAmt(double value) {
        this.referralRecieverAmt = value;
    }
