 ...
 *         &lt;element name="BusinessLinks" type="{http://uy.com.dlya.bantotal/BTSOA/}BusinessLinks"/>
...
@XmlRootElement(name = "CommonDataCross.RetrieveCompanyLinkResponse")
public class CommonDataCrossRetrieveCompanyLinkResponse {

    @XmlElement(name = "Btinreq", required = true)
    protected SBTInReq btinreq;
    @XmlElement(name = "BusinessLinks", required = true)
