 ...
 *         &lt;element name="DocumentTypes" type="{http://uy.com.dlya.bantotal/BTSOA/}DocumentTypes"/>
...
@XmlRootElement(name = "CommonDataCross.RetrieveDocumentsTypeResponse")
public class CommonDataCrossRetrieveDocumentsTypeResponse {

    @XmlElement(name = "Btinreq", required = true)
    protected SBTInReq btinreq;
    @XmlElement(name = "DocumentTypes", required = true)
