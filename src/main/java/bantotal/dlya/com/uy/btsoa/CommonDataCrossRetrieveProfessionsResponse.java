 ...
 *         &lt;element name="Professions" type="{http://uy.com.dlya.bantotal/BTSOA/}Professions"/>
...
@XmlRootElement(name = "CommonDataCross.RetrieveProfessionsResponse")
public class CommonDataCrossRetrieveProfessionsResponse {

    @XmlElement(name = "Btinreq", required = true)
    protected SBTInReq btinreq;
    @XmlElement(name = "Professions", required = true)
    protected Professions professions;
     ...
     *     
     */
    public void setProfessions(Professions value) {
